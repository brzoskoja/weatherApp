...
import { changeWeather } from "./app.js"
...
function updateWeather(weatherModule, weatherData) {
    ...
    let editButton = weatherModule.querySelector(".button_edit");
    editButton.addEventListener("click", () => {
        let cityName = weatherModule.querySelector(".city__name");
        ...
        cityName.setAttribute("contentEditable", false);
        })
    })
